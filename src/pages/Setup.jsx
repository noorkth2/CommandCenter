...
VITE_APP_VERSION=1.0.0`;
  ...
  return (
    <div className="min-h-screen bg-bg-base text-text-primary flex items-center justify-center p-6 select-none relative">
      ...
      <div className="absolute bottom-1/4 left-1/3 w-[300px] h-[300px] bg-brand-purple/5 rounded-full blur-[100px] pointer-events-none" />

      <div className="w-full max-w-2xl bg-bg-surface border border-border rounded-xl shadow-overlay p-8 relative overflow-hidden animate-scale-in">
        ...
        <div className="space-y-6">
          {/* Status warning card */}
          <div className="p-4 bg-brand-amber/10 border border-brand-amber/20 rounded-lg flex items-start gap-3">
            <AlertTriangle size={18} className="text-brand-amber flex-shrink-0 mt-0.5" />
          ...
          <div className="space-y-5">
            ...
            <div className="flex gap-4">
              <div className="flex flex-col items-center">
                <div className="w-6 h-6 rounded-full bg-brand-blue/20 border border-brand-blue/40 flex items-center justify-center text-xs font-semibold text-brand-blue">
                  1
                </div>
              ...
              <div className="flex-1 pb-4">
                ...
                <p className="text-xs text-text-secondary mt-1 leading-relaxed">
                  Go to <a href="https://supabase.com" target="_blank" rel="noopener noreferrer" className="text-brand-blue hover:underline">supabase.com</a>, sign in or sign up, and create a new project. Give it a name like <code className="text-brand-purple">command-center</code>.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1 pb-4">
                ...
                <div className="mt-2 p-2 bg-bg-elevated border border-border rounded flex items-center justify-between">
                  ...
                  >
                    {copiedSql ? <Check size={11} className="text-brand-green" /> : <Copy size={11} />}
                    <span className="text-[10px]">{copiedSql ? 'Copied Path' : 'Copy Path'}</span>
                  </Button>
                </div>
                <p className="text-xs text-text-secondary mt-2 leading-relaxed">
                  Paste the SQL into the editor and click <strong>Run</strong>. This will set up the tables (<code className="text-brand-purple">projects</code>, <code className="text-brand-purple">issues</code>, <code className="text-brand-purple">qa_items</code>, etc.) and pre-seed built-in automation rules.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-text-secondary mt-1 leading-relaxed">
                  Go to <strong>Project Settings → API</strong> in your Supabase dashboard. Copy your <strong>Project URL</strong> and <strong>Anon Public Key</strong>, then paste them into your <code className="text-brand-purple">.env</code> file:
                </p>
                ...
                <div className="mt-3 relative rounded-lg border border-border overflow-hidden bg-bg-base font-mono">
                  <div className="flex items-center justify-between px-4 py-2 border-b border-border bg-bg-elevated">
                    ...
                    >
                      {copiedEnv ? <Check size={14} className="text-brand-green" /> : <Copy size={14} />}
                    </button>
                  </div>
        ...
        <div className="flex items-center justify-between mt-8 pt-5 border-t border-border">
          <div className="flex items-center gap-2 text-text-muted">
            <RefreshCw size={13} className="animate-spin text-brand-blue" />
          ...
          <Button
            ...
            className="glow-blue flex items-center gap-1.5"
          >
